...
object Levels {
    private val levels = arrayOf(
        Level(
            ...
            ghostHouseSpeed = Speeds.`40`,
            scatterAndChaseTimes = intArrayOf(7 * 75, 20 * 75, 7 * 75, 20 * 75, 5 * 75, 20 * 75, 5 * 75, Int.MAX_VALUE),
            scaredLimit = 6 * 75,
            scaredFlashes = 5,
            inkyDotLimit = 30,
            clydeDotLimit = 60,
        ...
        Level(
            ...
            ghostEyesSpeed = Speeds.`150`,
            ghostHouseSpeed = Speeds.`40`,
            scatterAndChaseTimes = intArrayOf(7 * 75, 20 * 75, 7 * 75, 20 * 75, 5 * 75, 1033 * 75, 1, Int.MAX_VALUE),
            scaredLimit = 5 * 75,
            scaredFlashes = 5,
            inkyDotLimit = 0,
            clydeDotLimit = 50,
        ...
        Level(
            ...
            ghostEyesSpeed = Speeds.`150`,
            ghostHouseSpeed = Speeds.`40`,
            scatterAndChaseTimes = intArrayOf(5 * 75, 20 * 75, 5 * 75, 20 * 75, 5 * 75, 1037 * 75, 1, Int.MAX_VALUE),
            scaredLimit = 2 * 75,
            scaredFlashes = 5,
            inkyDotLimit = 0,
            clydeDotLimit = 0,
